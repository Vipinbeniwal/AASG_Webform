...
{
    public class ProcessPackaging : CommonProperties
    {
        public int process_packaging_id { get; set; }
        ...
        public System.DateTime packaging_started_on { get; set; }
        public System.DateTime packaging_ended_on { get; set; }
        ...
        public string packaging_status { get; set; }
    }
}
