...
{
    public class ProcessHole : CommonProperties
    {
        public int process_hole_id { get; set; }
        ...
        public System.DateTime hole_started_on { get; set; }
        public System.DateTime hole_ended_on { get; set; }
