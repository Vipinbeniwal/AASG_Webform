...
{
    public class ProcessWashingOne : CommonProperties
    {
        public int process_washing_one_id { get; set; }
        ...
        public System.DateTime washing_started_on { get; set; }
        public System.DateTime washing_ended_on { get; set; }
        ...
        public string washing_one_status { get; set; }
