...
{
    public class ProcessGrinding : CommonProperties
    {
        public int process_grinding_id { get; set; }
        ...
        public System.DateTime grinding_started_on { get; set; }
        public System.DateTime grinding_ended_on { get; set; }
        ...
        public string grinding_status { get; set; }
    }
}
