...
{
    public class ProcessPaint : CommonProperties
    {
        public int process_paint_id { get; set; }
        ...
        public System.DateTime paint_started_on { get; set; }
        public System.DateTime paint_ended_on { get; set; }
        ...
        public string paint_status { get; set; }
    }
}
