...
{
    public class ProcessStore : CommonProperties
    {
        public int process_store_id { get; set; }
        ...
        public System.DateTime store_started_on { get; set; }
        public System.DateTime store_ended_on { get; set; }
