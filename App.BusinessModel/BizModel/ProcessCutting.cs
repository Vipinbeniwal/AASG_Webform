...
{
    public class ProcessCutting : CommonProperties
    {
        public int process_cutting_id { get; set; }
        ...
        public Nullable<int> kept_on_floor_item_pcs_received { get; set; }
        public int production_quantity { get; set; }
        public System.DateTime cutting_started_on { get; set; }
        public System.DateTime cutting_ended_on { get; set; }
        ...
        public string sheet_height { get; set; }
        public string sheet_width { get; set; }
        ...
        public string cutting_status { get; set; }
