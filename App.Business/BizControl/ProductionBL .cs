...
namespace App.Business
{
    public class ProductionBL
    {
        ...
        /// <summary>
        /// This Method is Used to Get Item Already in Production or Not
        /// </summary>
        /// <param name="Id"></param>
        /// <returns></returns>
        public List<BusinessModel.Production> GetProductionItemsProductionStatusByID(int Id)
        {
            Mapper.Mappings.MapProduction ProductionMenu = new Mapper.Mappings.MapProduction();

            var ProductionItemsDALList = this._ProductionDAL.GetProductionDetailsbyItemMasterId(Id);
