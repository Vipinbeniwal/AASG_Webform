<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AASGWeb.Login" %>
...
<head runat="server">
    ...
    <title>AASG World - Admin Portal</title>

    <meta name="description" content="AASG World is an Admin Portal created by Nijomee." />
    <meta name="author" content="Nijomee" />
        ...
        <div>
            ...
            <div id="login-container" class="animation-fadeIn">
                ...
                <div class="login-title text-center">
                    <h1><i class="gi gi-flash"></i> <strong>AASG World</strong><br /> 
                    ...
                    <div id="form-login" class="form-horizontal form-bordered form-control-borderless">
                        ...
                        <div class="form-group form-actions">
                            <div class="col-xs-4">
                                <label class="switch switch-primary" data-toggle="tooltip" title="I agree to the terms!">
                                    ...
                                    <asp:CheckBox ID="val_terms" runat="server"    />
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12 text-center">
                                <a href="#" id="link-register-login" target="_blank"><small>Term & Conditions</small></a> -
                                <a href="#" id="link-reminder-login"><small>Forgot password?</small></a>
                                <%--/recover-password--%>
                            </div>
                        </div>
                    </div>
