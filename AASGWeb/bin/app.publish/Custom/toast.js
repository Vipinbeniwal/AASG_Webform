...
function showAlertPurchasePartyName() {
    ...
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please Select Party Name for Purchase Order!</b></p>', {
            type: 'danger',
...
function showDeletePermissionAlert() {
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>You can not Delete Item After Confirmation/Submit !</b></p>', {
            type: 'warning',
            delay: 2500,
            allow_dismiss: true
        }, 2000);
...
function showAlreadyPartyPhonenumber() {
    $(document).ready(function () {
        /* Grawl Notifications with Bootstrap-growl plugin, check out more examples at http://ifightcrime.github.io/bootstrap-growl/ */

        var growlType = $(this).data('growl');

        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>This Phone Number Already Used By Another Party !</b></p>', {
            type: 'danger',
            delay: 2500,
            allow_dismiss: true
        }, 2000);
...
function showAlertClientName() {
    ...
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please Select Client Name!</b></p>', {
            type: 'danger',
...
function showAlertItemTypeName() {
    ...
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please Select Item Type Name!</b></p>', {
            type: 'danger',
...
function showAlertItem() {
    ...
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please Select Item!</b></p>', {
            type: 'danger',
...
function showAlertItemQuantity() {
    ...
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please fill Item Quantity!</b></p>', {
            type: 'danger',
...
function showAlertItemBilling() {
    ...
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please fill Item Billing Percentage!</b></p>', {
            type: 'danger',
...
function showAlertItemDiscount() {
    ...
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please fill Item Billing Discount!</b></p>', {
            type: 'danger',
...
function showAlertItemPrice() {
    ...
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please fill Item Price!</b></p>', {
            type: 'danger',
...
function showAlertGenerateLoadingSlip() {
    ...
    $(document).ready(function () {
        ...
        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please Genearte loading-slip first !</b></p>', {
            type: 'danger',
...
function showAlertItemMRP() {
    $(document).ready(function () {
        /* Grawl Notifications with Bootstrap-growl plugin, check out more examples at http://ifightcrime.github.io/bootstrap-growl/ */

        var growlType = $(this).data('growl');

        $.bootstrapGrowl('<h4>Warning!</h4> <p><b>Please Enter Item MRP!</b></p>', {
            type: 'danger',
            delay: 2500,
            allow_dismiss: true
        }, 2000);
