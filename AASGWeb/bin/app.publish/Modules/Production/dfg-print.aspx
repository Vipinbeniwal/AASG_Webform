<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="dfg-print.aspx.cs" Inherits="AASGWeb.Modules.Production.dfg_print" %>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="example-department2" name="example-chosen" class="select-chosen" data-placeholder="Choose a Department" style="width: 250px;">
                                                            ...
                                                            <option value="DFG Print" selected>DFG Print</option>
            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    ...
                    <div class="block-title">
                        ...
                        <h2><strong></strong>DFG Print Department</h2>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtreceived" runat="server" CssClass="form-control" placeholder="" Text="102"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:Repeater ID="rptrBreakagePcsItemList" runat="server" Visible="false" OnItemCommand="rptrBreakagePcsItemList_ItemCommand" OnItemDataBound="rptrBreakagePcsItemList_ItemDataBound">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class=" text-center">
                                                <%--<asp:TextBox ID="txtBreakageReason" runat="server" CssClass="form-control text-center" Text='<%#Eval("Reason")%>'  ></asp:TextBox>--%>
                                ...
                                <asp:Repeater ID="rptrRejectPcsItemList" runat="server" Visible="false" OnItemCommand="rptrRejectPcsItemList_ItemCommand" OnItemDataBound="rptrRejectPcsItemList_ItemDataBound">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class=" text-center">
                                                <%--<asp:TextBox ID="txtRejectReason" runat="server" CssClass="form-control text-center" Text='<%#Eval("Reason")%>' ></asp:TextBox>--%>
