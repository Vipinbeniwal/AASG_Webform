<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="add-procurement.aspx.cs" Inherits="AASGWeb.Modules.Xp_Master.add_procurement" %>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="visible-lg text-center">
                                    <asp:Label ID="lblBrnad" Text='<%#Eval("brand")%>' runat="server"> </asp:Label>
                                </td>
                                 <td class="visible-lg text-center">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtTotalPaid" runat="server" CssClass="form-control" placeholder="Enter Paid Amount" AutoPostBack="True"  OnTextChanged="txtTotalPaid_TextChanged"> </asp:TextBox>
