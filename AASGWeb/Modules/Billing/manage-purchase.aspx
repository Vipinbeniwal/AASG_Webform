<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="manage-purchase.aspx.cs" Inherits="AASGWeb.Modules.Billing.manage_purchase" %>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class=" text-center btn-group btn-group-xs ">
                            ...
                            <asp:LinkButton ID="btnSendEmail" runat="server" CommandName="send" CommandArgument='<%# Eval("purchase_header_id")%>' CssClass="btn btn-xs btn-primary text-center" data-toggle="tooltip" data-placement="bottom" title="Click to Send Email" data-original-title="Basic tooltp"><i class="gi gi-envelope"></i></asp:LinkButton>
