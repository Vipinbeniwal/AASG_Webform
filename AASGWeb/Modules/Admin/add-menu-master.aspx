<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="add-menu-master.aspx.cs" Inherits="AASGWeb.Modules.Admin.add_menu_master" %>
                        ...
                        <div class="col-md-4">
                                <div class="form-group">
                                    <label for="txtParentOrder">Parent Order <span class="text-danger">*</span></label>
                                       <asp:TextBox ID="txtParentOrder" runat="server" CssClass="form-control" placeholder="Parent Order" MaxLength="3" onkeydown="return (!((event.keyCode >= 65) && event.keyCode != 32) || (event.keyCode >= 48 && event.keyCode <= 57) || (event.keyCode >= 96 && event.keyCode <= 105));"></asp:TextBox>
                                </div>
                            </div>
                        </div>
        ...
        <div class="block">
            ...
            <div class="block-title">
                ...
                <div class="block-options pull-right" style="padding-right: 1.3rem;">
                    <asp:LinkButton runat="server" ID="btnExportToExcel" CssClass="btn btn-default" OnClick="btnExportToExcel_Click" title="Export Excel"><i class="fa fa-file-excel-o"></i></asp:LinkButton>
                </div>
             ...
             <asp:Repeater ID="rptrMenuDetails" runat="server" OnItemCommand="rptrMenuDetails_ItemCommand" OnItemDataBound="rptrMenuDetails_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="text-left">
                            <asp:Label ID="lblDisplayName" Text='<%# Eval("display_name")%>' runat="server"></asp:Label>
                        </td>
                        <td class="text-left">
                        ...
                        <%--<td>
                            <asp:Label ID="lblStatus" CssClass="label label-success" Text='<%# Eval("is_active")%>' runat="server"></asp:Label>
                        </td>--%>
                        <td class="text-center">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <script type="text/javascript">
        $(function () {
            $("[id*=grdMenu] td").hover(function () {
                $("td", $(this).closest("tr")).addClass("row_hover");
            }, function () {
                $("td", $(this).closest("tr")).removeClass("row_hover");
            });
        });
    </script>
</asp:Content>