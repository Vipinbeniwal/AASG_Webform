<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="grinding.aspx.cs" Inherits="AASGWeb.Modules.Production.grinding" %>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="example-department2" name="example-chosen" class="select-chosen" data-placeholder="Choose a Department" style="width: 250px;">
                                                            ...
                                                            <option value="Grinding" selected>Grinding</option>
            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    ...
                    <div class="block-title">
                        ...
                        <h2><strong></strong>Grinding Department</h2>
                    </div>
