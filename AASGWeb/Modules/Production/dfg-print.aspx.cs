...
{
    public partial class dfg_print : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    string _dfgPrintItemid = RouteData.Values["id"].ToString();
                    ItemId = App.Core.DataSecurity.Decryptdata(_dfgPrintItemid);
        ...
        private void PopulateData(string ItemId)
        {
            ...
            {
                hdnItemId.Value = ItemId;
                Int32 ProcessDfgPrintID = Convert.ToInt32(ItemId);

                _objProcessDfgPrintBL = new ProcessDfgPrintBL();

                _objProcessDfgPrint = _objProcessDfgPrintBL.GetAllProcessDfgPrintItems().Where(x => x.process_dfg_print_id == Convert.ToInt32(ProcessDfgPrintID)).FirstOrDefault();

                //_objProcessDfgPrintBL = new ProcessDfgPrintBL();
                //ProcessDfgPrint _objProcessDfgPrint = new ProcessDfgPrint();
                //_lstProcessDfgPrint = _objProcessDfgPrintBL.GetAllProcessDfgPrintItems().Where(x=>x.process_cutting_id==Convert.ToInt32(_ProcessDfgPrintid)).ToList();
                if (_objProcessDfgPrint != null)
                {
                    _objItemMasterBL = new ItemMasterBL();
                    _objItemMaster = _objItemMasterBL.GetItemMasterItemsByID(_objProcessDfgPrint.item_master_id).FirstOrDefault();
                    ...
                    txtreceived.Text = _objProcessDfgPrint.total_received.ToString();
                    txtbreakage.Text = _objProcessDfgPrint.total_broken.ToString();
                    txtReject.Text = _objProcessDfgPrint.total_reject.ToString();
                    txtFinalTransferred.Text = _objProcessDfgPrint.total_pcs_transferred.ToString();
                    ddlSignature.SelectedValue = _objProcessDfgPrint.signature.ToString();
                    txtRemarks.Text = _objProcessDfgPrint.remarks;

                    if (_objProcessDfgPrint.total_broken > 0)
                    {
                        bindBreakageReason(_objProcessDfgPrint.total_broken);
                    }
                    else
                    {
                    ...
                    if (_objProcessDfgPrint.total_reject > 0)
                    {
                        bindRejectReason(_objProcessDfgPrint.total_reject);
                    }
                    else
                    {
                    ...
                    if (_objProcessDfgPrint.total_pcs_transferred > 0)
                    {
                        txtFinalTransferred.Text = _objProcessDfgPrint.total_pcs_transferred.ToString();
        ...
        {
            Int32 ProcessDfgPrintID = Convert.ToInt32(hdnItemId.Value);
            ...
            if (_objProcessDfgPrint != null)
            {
                ...
                if (_objProcessDfgPrint.breakage_pcs_number == null)
                {

                }
                else
                {
                    string breakagePcsNumber = _objProcessDfgPrint.breakage_pcs_number;
                    string lasttmPcsNumber = breakagePcsNumber.TrimEnd(',');
                    arrOfSelectionsPcsNumber = lasttmPcsNumber.Split(',');
                }
                if (_objProcessDfgPrint.breakage_reason == null)
                {

                }
                else
                {
                    string breason = _objProcessDfgPrint.breakage_reason;
        ...
        private void bindRejectReason(int total_reject)
        {
            ...
            if (_objProcessDfgPrint != null)
            {
                ...
                if (_objProcessDfgPrint.reject_pcs_number == null)
                {
                }
                else
                {
                    string rejectPcsNumber = _objProcessDfgPrint.reject_pcs_number;
                    string lasttmPcsNumber = rejectPcsNumber.TrimEnd(',');
                    arrOfSelectionsRejectPcsNumber = lasttmPcsNumber.Split(',');
                }
                if (_objProcessDfgPrint.reject_reason == null)
                {

                }
                else
                {
                    string rejectReason = _objProcessDfgPrint.reject_reason;
        ...
        {
            _objProcessDfgPrint = new ProcessDfgPrint();
            _objProcessDfgPrintBL = new ProcessDfgPrintBL();
            ...
            try
            {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            _objProcessDfgPrint = _objProcessDfgPrintBL.GetAllProcessDfgPrintItems().Where(x => x.process_dfg_print_id == Convert.ToInt32(hdnItemId.Value)).FirstOrDefault();
                            if (_objProcessDfgPrint.process_dfg_print_id > 0)
                            {
                                _objProcessDfgPrint = _objProcessDfgPrintBL.UpdateProcessDfgPrint(GetProcessDfgPrintUpdateObject());
                                if (_objProcessDfgPrint.process_dfg_print_id > 0)
                                {
                                    //int itemMasterId = _objProcessDfgPrint.item_master_id;
                                    //string batchNumber = _objProcessDfgPrint.batch_number;
                                    ...
                                    if (_objProduction.production_id > 0)
                                    {
                                        ...
                                        if (_objProduction.production_id > 0)
                                        {
                                            ...
                                            string _heading = "DFG Print Submitted Successfully";
                                            string _heading_class = "text-success";
                                            string _activity = "DFG Print Submitted with Total Pcs Received:" + _objProcessDfgPrint.total_received + ", Breakage:" + _objProcessDfgPrint.total_broken + "" + ", Rejected:" + _objProcessDfgPrint.total_reject + ", Total Pcs Transfer:" + _objProcessDfgPrint.total_pcs_transferred;
                                          ...
                                          //  ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "showDfgPrintProcessSuccess();", true);
                                        }
        ...
        private ProcessDfgPrint GetProcessDfgPrintUpdateObject()
        {
            
            string breakReasonData = null;
            if (txtbreakage.Text == "0")
            {
                _objProcessDfgPrint.breakage_reason = "";
            }
            else
            {
                ...
                _objProcessDfgPrint.breakage_reason = totalBreakReasonData;
                ...
                _objProcessDfgPrint.breakage_pcs_number = totalBreakagePcsNumber;
                _objProcessDfgPrint.dfg_status = App.Helper.Utils.OrderStatus.progress.ToString();
            }
            ...
            if (txtReject.Text == "0")
            {
                _objProcessDfgPrint.reject_reason = "";
            }
            else
            {
                ...
                _objProcessDfgPrint.reject_reason = totalRejectReasonData;
                ...
                _objProcessDfgPrint.reject_pcs_number = totalRejectPcsNumber;
            }


            _objProcessDfgPrint.total_received = _objProcessDfgPrint.total_received;
            //_objProcessDfgPrint.total_received = Convert.ToInt32(txtreceived.Text);
            _objProcessDfgPrint.total_broken = Convert.ToInt32(txtbreakage.Text);
            _objProcessDfgPrint.total_reject = Convert.ToInt32(txtReject.Text);
            _objProcessDfgPrint.total_pcs_transferred = Convert.ToInt32(txtFinalTransferred.Text);

            _objProcessDfgPrint.signature = Convert.ToInt32(ddlSignature.SelectedValue);
            _objProcessDfgPrint.dfg_print_ended_on = System.DateTime.Now;
            _objProcessDfgPrint.remarks = txtRemarks.Text;
            _objProcessDfgPrint.dfg_status = App.Helper.Utils.OrderStatus.complete.ToString();
