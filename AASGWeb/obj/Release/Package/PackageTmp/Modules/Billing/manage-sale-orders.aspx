<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="manage-sale-orders.aspx.cs" Inherits="AASGWeb.Modules.Billing.manage_sale_orders" %>
                    ...
                    <table id="example-datatable" class="table table-bordered table-striped table-vcenter">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center visible-lg">Order ID</th>
                                <th class="text-center hidden-xs">Party Name</th>
                                <th class="text-center hidden-xs">Items Quan.</th>
                                <th class="text-center hidden-xs">Total Amount</th>
                                <th class="text-center hidden-xs">Date</th>
                                <th class="text-center hidden-xs">Order By (Staff)</th>
                                <th>Order Status</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class=" text-center  btn-group-xs ">
                            <asp:LinkButton ID="btnView" runat="server" CommandName="view" CommandArgument='<%# Eval("sale_header_id")%>' CssClass="btn btn-default text-center" data-toggle="tooltip" data-placement="bottom" title="Click to view" data-original-title="Basic tooltp"><i class="fa fa-eye"></i></asp:LinkButton>
                            <asp:LinkButton ID="btnEdit" runat="server" CommandName="edit" CommandArgument='<%# Eval("sale_header_id")%>' CssClass="btn btn-default text-center" data-toggle="tooltip" data-placement="bottom" title="Click to edit" data-original-title="Basic tooltp"><i class="fa fa-pencil"></i></asp:LinkButton>
